...
Finally, a small set of sentences from scientific papers in the \textit{CORD-19} corpus (in English language) are selected, annotated, and distributed in the development, and testing collections. Overall, the composition of the corpus is presented in Table~\ref{tab:corpus}\footnote{\url{https://ehealthkd.github.io/2021/resources}}.
...
\todo[inline]{Comentar GuanZengyi con respecto a la complejidad del transfer learning...}
...
\begin{table*}[htb]
  ...
  \begin{tabular}{l|rrrr|rrrr|rrrr}
    ...
    \midrule
Vicomtech        & \bf 0.843 &  0.156 & 0.467 & 0.093 & \bf 0.794 & 0.106 & 0.478 &  0.104 & 0.576 & -0.111 & 0.256 & -0.118 \\
PUCRJ-PUCPR-UFMG & 0.779 &  0.071 & 0.374 & 0.109 & 0.781 & 0.073 & 0.362 &  0.098 & \bf 0.641 & -0.067 & 0.170 & -0.095 \\
IXA              & 0.699 &  0.045 & \bf 0.562 & 0.130 & 0.714 & 0.060 & \bf 0.493 &  0.062 & 0.609 & -0.045 & \bf 0.338 & -0.094 \\
...
\todo[inline]{Grafica de lineas para ver la evolucion del transferlearning entre diminios}
...
\todo[inline]{Grafica de dispersion dificultad para identificar cada tipo de etiqueta}
