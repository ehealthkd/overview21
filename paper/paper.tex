...
\begin{table*}
  ...
  \caption{Summary of results in the three evaluation scenarios of the eHealth-KD Challenge. The top result in every metric is highlighted.\label{tab:results}}
\end{table*}
...
The human benchmark, estimated by inter-annotator agreement, is at least $10$ to $20$ percentual points above the best performing systems in both subtasks, with this gap being larger in subtask B.\todo{estimate human benchmark}
...
However, there is a significant gap in performance across domains and languages, as shown by Table~\ref{tab:models}.\todo{diferencias por dominio y lenguaje}
