...
\begin{table*}
  ...
  \begin{tabular}{l|rrrr|rrrr|rrrr}
    \toprule
    & \multicolumn{4}{c|}{Medline} & \multicolumn{4}{c|}{Wikinews} & \multicolumn{4}{c}{CORD} \\
    & \multicolumn{2}{c}{Task A} & \multicolumn{2}{c|}{Task B} & \multicolumn{2}{c}{Task A} & \multicolumn{2}{c|}{Task B} & \multicolumn{2}{c}{Task A} & \multicolumn{2}{c}{Task B} \\
    Team & $F_1$ & Diff & $F_1$ & Diff & $F_1$ & Diff & $F_1$ & Diff & $F_1$ & Diff & $F_1$ & Diff \\
    \midrule
...
Maoqin           & 0.266 &  0.094 & 0.000 & 0.000 & 0.269 & 0.097 & 0.000 &  0.000 & 0.000 & -0.172 & 0.000 &  0.000 \\
    \midrule
    Average Diff &       &  0.136 &       & 0.087 &       & 0.063 &       &  0.038 &       & -0.114 &       & -0.064 \\
    \bottomrule
  \end{tabular}}
